---
title: Análise descritiva para dados de nascidos vivos diagnosticados com anomalia congênita - 11-20
header-includes:
...
```{r}
d_anom <- readr::read_csv("01.dados/anomalias/microdados_ac_11-20.csv") |> 
...
cid_maior <- readxl::read_xlsx("02.analise/tab_auxiliares/cid10_eurocat.xlsx", sheet = 1)

# cids menores, segundo eurocat

cid_menor <- readxl::read_xlsx("02.analise/tab_auxiliares/cid10_eurocat.xlsx", sheet = 2)
...
Código omitido. Verificar no arquivo `analise_descritiva[2024-02-09].Rmd` (linhas 497-786).

```{r echo=FALSE}
# # tabela que identifica o grupo e subgrupo das cids
# 
# dados_subgrupos <- readxl::read_xlsx("02.analise/tab_auxiliares/subgrupos_cid10.xlsx") |>
...
#   transpose()
# 
# saveRDS(soma_cids, "02.analise/soma_auxiliar/soma_cids.rds")
```
...
soma_cids_malf <- readRDS("02.analise/soma_auxiliar/soma_cids.rds")
...
Código omitido. Verificar no arquivo `analise_descritiva[2024-02-09].Rmd` (linhas 1331-2309).
...
d_recod <- readxl::read_excel("02.analise/tab_auxiliares/coda_recod.xlsx") |>
  rename(cid10_coa = `...4`) |>
  select(cid10, cid10_coa)

# tabela com os nomes das cids

d_nomes <- readxl::read_xlsx("02.analise/tab_auxiliares/cid10_eurocat.xlsx", sheet = 1) |>
...
freqs_cid10 <- readxl::read_xlsx("02.analise/tab_auxiliares/freqs_cid10_eurocat.xlsx", skip = 1)
...
```{r}
readxl::read_xlsx("02.analise/tab_auxiliares/freqs_cid10_eurocat.xlsx", skip = 1) |> 
  mutate(
    grupo = case_when(
      grupo == "Membros" ~ "Limbs",
...
Código omitido. Verificar no arquivo `analise_descritiva[2024-02-09].Rmd` (linhas 2458-2813).
...
d_all_anom_geral <- readxl::read_xlsx("02.analise/tab_auxiliares/n_nv_por_categoria.xlsx")
...
Código omitido. Verificar no arquivo `analise_descritiva[2024-02-09].Rmd` (linhas 2742-3002).
